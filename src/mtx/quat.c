...
void C_QUATAdd(const Quaternion* p, const Quaternion* q, Quaternion* r) {
    ASSERTMSGLINE(64, p, "QUATAdd():  NULL QuaternionPtr 'p' ");
    ASSERTMSGLINE(65, q, "QUATAdd():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(66, r, "QUATAdd():  NULL QuaternionPtr 'r' ");
...
void C_QUATSubtract(const Quaternion* p, const Quaternion* q, Quaternion* r) {
    ASSERTMSGLINE(120, p, "QUATSubtract():  NULL QuaternionPtr 'p' ");
    ASSERTMSGLINE(121, q, "QUATSubtract():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(122, r, "QUATSubtract():  NULL QuaternionPtr 'r' ");
...
void C_QUATMultiply(const Quaternion* p, const Quaternion* q, Quaternion* pq) {
    ...
    ASSERTMSGLINE(180, p, "QUATMultiply():  NULL QuaternionPtr 'p' ");
    ASSERTMSGLINE(181, q, "QUATMultiply():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(182, pq, "QUATMultiply():  NULL QuaternionPtr 'pq' ");
...
void C_QUATScale(const Quaternion* q, Quaternion* r, f32 scale) {
    ASSERTMSGLINE(293, q, "QUATScale():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(294, r, "QUATScale():  NULL QuaternionPtr 'r' ");
...
f32 C_QUATDotProduct(const Quaternion* p, const Quaternion* q) {
    ASSERTMSGLINE(344, p, "QUATDotProduct():  NULL QuaternionPtr 'p' ");
    ASSERTMSGLINE(345, q, "QUATDotProduct():  NULL QuaternionPtr 'q' ");
...
void C_QUATNormalize(const Quaternion* src, Quaternion* unit) {
    f32 mag;
    ASSERTMSGLINE(394, src, "QUATNormalize():  NULL QuaternionPtr 'src' ");
    ASSERTMSGLINE(395, unit, "QUATNormalize():  NULL QuaternionPtr 'unit' ");
...
void C_QUATInverse(const Quaternion* src, Quaternion* inv) {
    f32 mag, norminv;
    ASSERTMSGLINE(485, src, "QUATInverse():  NULL QuaternionPtr 'src' ");
    ASSERTMSGLINE(486, inv, "QUATInverse():  NULL QuaternionPtr 'inv' ");
...
void PSQUATInverse(const register Quaternion* src, register Quaternion* inv) {
    ...
    asm {
        ...
        ps_sel norminv, nmag, c_one, norminv
        b L_0000094C
    L_00000948:
        fmr norminv, c_one
    L_0000094C:
...
void C_QUATDivide(const Quaternion* p, const Quaternion* q, Quaternion* r) {
    Quaternion qtmp;
    ASSERTMSGLINE(584, p, "QUATDivide():  NULL QuaternionPtr 'p' ");
    ASSERTMSGLINE(585, q, "QUATDivide():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(586, r, "QUATDivide():  NULL QuaternionPtr 'r' ");
...
void C_QUATExp(const Quaternion* q, Quaternion* r)  {
    f32 theta, scale;
    ASSERTMSGLINE(621, q, "QUATExp():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(622, r, "QUATExp():  NULL QuaternionPtr 'r' ");
    ASSERTMSGLINE(625, q->w == 0.0f, "QUATExp():  'q' is not a pure quaternion. ");
...
void C_QUATLogN(const Quaternion* q, Quaternion* r) {
    f32 theta, scale, mag;
    ASSERTMSGLINE(654, q, "QUATLogN():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(655, r, "QUATLogN():  NULL QuaternionPtr 'r' ");
...
void C_QUATMakeClosest(Quaternion* q, const Quaternion* qto, Quaternion* r) {
    f32 dot;
    ASSERTMSGLINE(700, q, "QUATMakeClosest():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(701, qto, "QUATMakeClosest():  NULL QuaternionPtr 'qto' ");
    ASSERTMSGLINE(702, r, "QUATMakeClosest():  NULL QuaternionPtr 'r' ");
...
void C_QUATRotAxisRad(Quaternion* r, const Vec* axis, f32 rad) {
    ...
    ASSERTMSGLINE(733, r, "QUATRotAxisRad():  NULL QuaternionPtr 'r' ");
    ASSERTMSGLINE(734, axis, "QUATRotAxisRad():  NULL VecPtr 'axis' ");
...
void C_QUATMtx(Quaternion* r, const Mtx m) {
    ...
    ASSERTMSGLINE(766, r, "QUATMtx():  NULL QuaternionPtr 'r' ");
    ASSERTMSGLINE(767, m, "QUATMtx():  NULL MtxPtr 'm' ");
...
void C_QUATLerp(const Quaternion* p, const Quaternion* q, Quaternion* r, f32 t) {
    ASSERTMSGLINE(817, p, "QUATLerp():  NULL QuaternionPtr 'p' ");
    ASSERTMSGLINE(818, q, "QUATLerp():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(819, r, "QUATLerp():  NULL QuaternionPtr 'r' ");
...
void C_QUATSlerp(const Quaternion* p, const Quaternion* q, Quaternion* r, f32 t) {
    ...
    ASSERTMSGLINE(844, p, "QUATSlerp():  NULL QuaternionPtr 'p' ");
    ASSERTMSGLINE(845, q, "QUATSlerp():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(846, r, "QUATSlerp():  NULL QuaternionPtr 'r' ");
...
void C_QUATSquad(const Quaternion* p, const Quaternion* a, const Quaternion* b, const Quaternion* q, Quaternion* r, f32 t) {
    ...
    ASSERTMSGLINE(902, p, "QUATSquad():  NULL QuaternionPtr 'p' ");
    ASSERTMSGLINE(903, a, "QUATSquad():  NULL QuaternionPtr 'a' ");
    ASSERTMSGLINE(904, b, "QUATSquad():  NULL QuaternionPtr 'b' ");
    ASSERTMSGLINE(905, q, "QUATSquad():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(906, r, "QUATSquad():  NULL QuaternionPtr 'r' ");
...
void C_QUATCompA(const Quaternion* qprev, const Quaternion* q, const Quaternion* qnext, Quaternion* a) {
    ...
    ASSERTMSGLINE(933, qprev, "QUATCompA():  NULL QuaternionPtr 'qprev' ");
    ASSERTMSGLINE(934, q, "QUATCompA():  NULL QuaternionPtr 'q' ");
    ASSERTMSGLINE(935, qnext, "QUATCompA():  NULL QuaternionPtr 'qnext' ");
    ASSERTMSGLINE(936, a, "QUATCompA():  NULL QuaternionPtr 'a' ");
