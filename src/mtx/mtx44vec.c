...
void C_MTX44MultVec(const Mtx44 m, const Vec* src, Vec* dst) {
    ...
    ASSERTMSGLINE(64, m, "MTX44MultVec():  NULL Mtx44Ptr 'm' ");
    ASSERTMSGLINE(65, src, "MTX44MultVec():  NULL VecPtr 'src' ");
    ASSERTMSGLINE(66, dst, "MTX44MultVec():  NULL VecPtr 'dst' ");
...
void C_MTX44MultVecArray(const Mtx44 m, const Vec* srcBase, Vec* dstBase, u32 count) {
    ...
    ASSERTMSGLINE(151, m, "MTX44MultVecArray():  NULL Mtx44Ptr 'm' ");
    ASSERTMSGLINE(152, srcBase, "MTX44MultVecArray():  NULL VecPtr 'srcBase' ");
    ASSERTMSGLINE(153, dstBase, "MTX44MultVecArray():  NULL VecPtr 'dstBase' ");
...
void C_MTX44MultVecSR(const Mtx44 m, const Vec* src, Vec* dst) {
    ...
    ASSERTMSGLINE(285, m, "MTX44MultVecSR():  NULL Mtx44Ptr 'm' ");
    ASSERTMSGLINE(286, src, "MTX44MultVecSR():  NULL VecPtr 'src' ");
    ASSERTMSGLINE(287, dst, "MTX44MultVecSR():  NULL VecPtr 'dst' ");
...
void C_MTX44MultVecArraySR(const Mtx44 m, const Vec* srcBase, Vec* dstBase, u32 count) {
    ...
    ASSERTMSGLINE(376, m, "MTX44MultVecArraySR():  NULL Mtx44Ptr 'm' ");
    ASSERTMSGLINE(377, srcBase, "MTX44MultVecArraySR():  NULL VecPtr 'srcBase' ");
    ASSERTMSGLINE(378, dstBase, "MTX44MultVecArraySR():  NULL VecPtr 'dstBase' ");
